...
pca <- preProcess(x = trainning_set[, -14],
                  method = "pca",
                  pcaComp = 2)
trainning_set <- predict(pca, trainning_set)
trainning_set <- trainning_set[, c(2, 3, 1)]
...
# Prediccion de svm con el conjunto de prueba
